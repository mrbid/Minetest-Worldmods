minetest.register_entity("automobiles2:suv4", {
	automobile2_name = "suv4",
	isflying = true,
	...
	decell = 0.1, -- decelleration per second
	...
	textures = {"automobiles2_suv4.png"},
	stepheight = 1.1,
	hp_max = 120,
	physical = true,
...
minetest.register_craftitem("automobiles2:suv4_spawner", {
	description = "Flying PsySUV1",
	inventory_image = "automobiles2_suv4_inv.png",
	on_place = function(item, placer, pointed_thing)
		local playerpos = placer:getpos();
		pointed_thing.above.y = pointed_thing.above.y - 0.5 -- no floating automobiles!
		local obj = minetest.env:add_entity(pointed_thing.above, "automobiles2:suv4")
...
minetest.register_craft({
	output = "automobiles2:suv4_spawner",
	recipe = {
		{"default:obsidian_glass", "default:obsidian_glass", "default:obsidian_glass"},
		{"default:steelblock", "basic_materials:motor", "default:steelblock"},
		{"bbq:propane", "biofuel:fuel_can", "bbq:propane"}
	},
})
