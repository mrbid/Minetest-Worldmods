...
local chest_name = "everything"
local chest_description = "Grants access to all nodes."
local icols = 14
local irows = 11
...
minetest.register_on_mods_loaded(function()
	...
	for itemstring,_ in pairs(minetest.registered_items) do
		if itemstring ~= "" and itemstring ~= "unknown" and itemstring ~= "ignore" and itemstring ~= "chest_of_everything:chest" and minetest.get_item_group(itemstring, "not_in_creative_inventory") == 0 and minetest.get_item_group(itemstring, "cnc_node") == 0 then
