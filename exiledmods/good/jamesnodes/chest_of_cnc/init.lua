...
local chest_description = "Lists all mesh/nodebox nodes."
local icols = 14
local irows = 11
...
minetest.register_on_mods_loaded(function()
	...
	for itemstring,_ in pairs(minetest.registered_items) do
		if itemstring ~= "" and itemstring ~= "unknown" and itemstring ~= "ignore" and minetest.get_item_group(itemstring, "cnc_node") == 1 then
