...
register_all_lamp("block_thermese_hot", 8)
...
register_all_lamp("glow_amethyst_ore", 6)
register_all_lamp("glow_ruby_ore", 6)
register_all_lamp("glow_emerald_ore", 6)
register_all_lamp("glow_ore", 6)

register_all_lamp_max("crystal_glass_detail")
register_all_lamp_max("glow_block_blue")
register_all_lamp_max("glow_block_green")
register_all_lamp_max("glow_block_orange")
register_all_lamp_max("glow_block_purple")
register_all_lamp_max("glow_block_red")
register_all_lamp_max("glow_block_white")
register_all_lamp_max("glow_block_yellow")

register_all_lamp_max("colorcubes_light_aqua")
register_all_lamp_max("colorcubes_light_blue")
register_all_lamp_max("colorcubes_light_cyan")
register_all_lamp_max("colorcubes_light_green")
register_all_lamp_max("colorcubes_light_lime")
register_all_lamp_max("colorcubes_light_magenta")
register_all_lamp_max("colorcubes_light_orange")
register_all_lamp_max("colorcubes_light_red")
register_all_lamp_max("colorcubes_light_redviolet")
register_all_lamp_max("colorcubes_light_skyblue")
register_all_lamp_max("colorcubes_light_violet")
register_all_lamp_max("colorcubes_light_white")
register_all_lamp_max("colorcubes_light_yellow")
