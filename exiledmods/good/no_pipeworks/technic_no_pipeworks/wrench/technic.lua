...
wrench:register_node("technic:titanium_locked_chest", {
	lists = {"main"},
	metas = {infotext = STRING,
		owner = STRING,
		formspec = STRING},
...
wrench:register_node("technic:amethyst_chest", {
	lists = {"main"},
	metas = {infotext = STRING,
		formspec = STRING},
})
wrench:register_node("technic:amethyst_locked_chest", {
	lists = {"main"},
	metas = {infotext = STRING,
		owner = STRING,
		formspec = STRING},
...
wrench:register_node("technic:diamond_chest", {
	lists = {"main"},
	metas = {infotext = STRING,
		formspec = STRING},
})
wrench:register_node("technic:diamond_locked_chest", {
	lists = {"main"},
	metas = {infotext = STRING,
		owner = STRING,
		formspec = STRING},
