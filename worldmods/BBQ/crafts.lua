...
-- Super Propane
minetest.register_node("bbq:superpropane", {
	description = ("Super Propane"),
	inventory_image = "bbq_superpropane.png",
	paramtype = "light",
	paramtype2 = "facedir",
	wield_image = "bbq_superpropane.png",
	drawtype = "plantlike",
	sunlight_propagates = true,
	tiles = {"bbq_superpropane.png"},
	groups = {explody = 1, dig_immediate = 3, attached_node = 1},
	sounds = default.node_sound_metal_defaults(),
})
