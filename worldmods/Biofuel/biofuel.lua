...
minetest.register_craftitem("biofuel:superfuel_can", {
	description = S("Canister of SUPER Biofuel"),
	inventory_image = "biofuel_superfuel_can.png"
})

minetest.register_craft({
	type = "fuel",
	recipe = "biofuel:superfuel_can",
	burntime = 495000,
})

minetest.register_craft({
	output = "biofuel:superfuel_can",
	recipe = {
			{"space_travel:titanium_ingot", "space_travel:titanium_ingot", "space_travel:titanium_ingot"},
			{"space_travel:titanium_ingot", "space_travel:bucket_liquid_hydrocarbon", "space_travel:titanium_ingot"},
			{"space_travel:titanium_ingot", "space_travel:titanium_ingot", "space_travel:titanium_ingot"}
		 }
})
