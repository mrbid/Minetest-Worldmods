...
local run = function(pos, node)
	...
	local machine_name = S("%s CNC Machine V2"):format("LV")
	local machine_node = "technic:cnc2"
	local demand       = 450
...
minetest.register_node(":technic:cnc2", {
	description = S("%s CNC Machine V2"):format("LV"),
	tiles       = {"technic_cnc2_top.png", "technic_cnc_bottom.png", "technic_cnc_side.png",
	               "technic_cnc_side.png", "technic_cnc_side.png", "technic_cnc2_front.png"},
	...
	on_construct = function(pos)
		local meta = minetest.get_meta(pos)
		meta:set_string("infotext", S("%s CNC Machine V2"):format("LV"))
...
-- Active state block
minetest.register_node(":technic:cnc2_active", {
	description = S("%s CNC Machine V2"):format("LV"),
	tiles       = {"technic_cnc2_top_active.png", "technic_cnc_bottom.png", "technic_cnc_side.png",
	               "technic_cnc_side.png",       "technic_cnc_side.png",   "technic_cnc2_front_active.png"},
	...
	on_receive_fields = form_handler,
	technic_run = run,
	technic_disabled_machine_name = "technic:cnc2",
})

technic.register_machine("LV", "technic:cnc2",        technic.receiver)
technic.register_machine("LV", "technic:cnc2_active", technic.receiver)
