dofile(minetest.get_modpath("doors").."/nondig.lua")
-- our API object
doors = {}
...
-- Adamantine
doors.register("door_adamantine", {
		tiles = {{name = "doors_door_adamantine.png", backface_culling = true}},
		description = "Adamantine Door",
		inventory_image = "doors_item_adamantine.png",
		protected = true,
		groups = {cracky = 1, level = 2},
		sounds = default.node_sound_metal_defaults(),
		sound_open = "doors_steel_door_open",
...
-- Aquarium
doors.register("door_aquarium", {
		tiles = {{name = "doors_door_aquarium.png", backface_culling = true}},
		description = "Aquarium Door",
		inventory_image = "doors_item_aquarium.png",
		protected = true,
		groups = {cracky = 1, level = 2},
		sounds = default.node_sound_metal_defaults(),
		sound_open = "doors_steel_door_open",
...
-- Brass
doors.register("door_brass", {
		tiles = {{name = "doors_door_brass.png", backface_culling = true}},
		description = "Brass Door",
		inventory_image = "doors_item_brass.png",
		protected = true,
		groups = {cracky = 1, level = 2},
		sounds = default.node_sound_metal_defaults(),
		sound_open = "doors_steel_door_open",
...
-- Mese
doors.register("door_mese", {
		tiles = {{name = "doors_door_mese.png", backface_culling = true}},
		description = "Mese Door",
		inventory_image = "doors_item_mese.png",
		protected = true,
		groups = {cracky = 1, level = 2},
		sounds = default.node_sound_metal_defaults(),
		sound_open = "doors_steel_door_open",
...
-- Diamond
doors.register("door_diamond", {
		tiles = {{name = "doors_door_diamond.png", backface_culling = true}},
		description = "Diamond Door",
		inventory_image = "doors_item_diamond.png",
		protected = true,
		groups = {cracky = 1, level = 2},
		sounds = default.node_sound_metal_defaults(),
		sound_open = "doors_steel_door_open",
...
--Adamantine trap
doors.register_trapdoor("doors:trapdoor_adamantine", {
	description = "Adamantine Trapdoor",
	inventory_image = "doors_trapdoor_adamantine.png",
	wield_image = "doors_trapdoor_adamantine.png",
	tile_front = "doors_trapdoor_adamantine.png",
	tile_side = "doors_trapdoor_side_adamantine.png",
	protected = true,
	sounds = default.node_sound_metal_defaults(),
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
...
minetest.register_craft({
	output = 'doors:trapdoor_adamantine',
	recipe = {
		{'doors:trapdoor_steel', 'doors:trapdoor_copper'},
	}
})
--Aquarium trap
doors.register_trapdoor("doors:trapdoor_aquarium", {
	description = "Aquarium Trapdoor",
	inventory_image = "doors_trapdoor_aquarium.png",
	wield_image = "doors_trapdoor_aquarium.png",
	tile_front = "doors_trapdoor_aquarium.png",
	tile_side = "doors_trapdoor_side_aquarium.png",
	protected = true,
	sounds = default.node_sound_metal_defaults(),
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
...
minetest.register_craft({
	output = 'doors:trapdoor_aquarium',
	recipe = {
		{"doors:trapdoor_copper", "doors:trapdoor_steel"},
	}
})
--Brass trap
doors.register_trapdoor("doors:trapdoor_brass", {
	description = "Brass Trapdoor",
	inventory_image = "doors_trapdoor_brass.png",
	wield_image = "doors_trapdoor_brass.png",
	tile_front = "doors_trapdoor_brass.png",
	tile_side = "doors_trapdoor_side_brass.png",
	protected = true,
	sounds = default.node_sound_metal_defaults(),
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
	groups = {cracky = 2, level = 2, door = 1},
})

minetest.register_craft({
	output = 'doors:trapdoor_brass',
	recipe = {
		{'doors:trapdoor_aquarium', 'doors:trapdoor_aquarium'},
	}
})
--Bronze trap
doors.register_trapdoor("doors:trapdoor_bronze", {
	description = "Bronze Trapdoor",
	inventory_image = "doors_trapdoor_bronze.png",
	wield_image = "doors_trapdoor_bronze.png",
	tile_front = "doors_trapdoor_bronze.png",
	tile_side = "doors_trapdoor_side_bronze.png",
	protected = true,
	sounds = default.node_sound_metal_defaults(),
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
...
doors.register_trapdoor("doors:trapdoor_gold", {
	...
	inventory_image = "doors_trapdoor_gold.png",
	wield_image = "doors_trapdoor_gold.png",
	tile_front = "doors_trapdoor_gold.png",
	tile_side = "doors_trapdoor_side_gold.png",
	protected = true,
	sounds = default.node_sound_metal_defaults(),
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
...
doors.register_trapdoor("doors:trapdoor_mese", {
	...
	inventory_image = "doors_trapdoor_mese.png",
	wield_image = "doors_trapdoor_mese.png",
	tile_front = "doors_trapdoor_mese.png",
	tile_side = "doors_trapdoor_side_mese.png",
	protected = true,
	sounds = default.node_sound_metal_defaults(),
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
...
doors.register_trapdoor("doors:trapdoor_diamond", {
	...
	tile_side = "doors_trapdoor_side_diamond.png",
	protected = true,
	sounds = default.node_sound_metal_defaults(),
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
...
--Copper trap
doors.register_trapdoor("doors:trapdoor_copper", {
	description = "Copper Trapdoor",
	inventory_image = "doors_trapdoor_copper.png",
	wield_image = "doors_trapdoor_copper.png",
	tile_front = "doors_trapdoor_copper.png",
	tile_side = "doors_trapdoor_side_copper.png",
	protected = true,
	sounds = default.node_sound_metal_defaults(),
	sound_open = "doors_steel_door_open",
	sound_close = "doors_steel_door_close",
