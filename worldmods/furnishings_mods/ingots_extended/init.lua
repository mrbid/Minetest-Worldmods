...
if minetest.get_modpath("space_travel") then
	ingots.register_ingots("space_travel:titanium_ingot", "ingot_titanium1.png", conf.is_big)
end
...
if minetest.get_modpath("xtraores") then
	ingots.register_ingots("xtraores:adamantite_ingot", "ingot_adamantite.png", conf.is_big)
	ingots.register_ingots("xtraores:cobalt_ingot", "ingot_cobalt.png", conf.is_big)
	ingots.register_ingots("xtraores:geminitinum_ingot", "ingot_geminitinum.png", conf.is_big)
