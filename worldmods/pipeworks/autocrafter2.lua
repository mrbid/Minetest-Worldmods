...
minetest.register_node("pipeworks:autocrafter2", {
	description = S("Devil Autocrafter"),
	drawtype = "normal",
	tiles = {"pipeworks_autocrafter2.png"},
...
minetest.register_craft( {
	output = "pipeworks:autocrafter2",
	recipe = {
		{ "lavastuff:block", "default:mese", "lavastuff:block" },
		{ "pipeworks:autocrafter1", "default:diamondblock", "pipeworks:autocrafter1" },
		{ "lavastuff:block", "default:mese", "lavastuff:block" }
	},
})
