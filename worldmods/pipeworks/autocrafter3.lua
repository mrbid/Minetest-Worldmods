...
minetest.register_node("pipeworks:autocrafter3", {
	description = S("Instant Autocrafter"),
	drawtype = "normal",
	tiles = {"pipeworks_autocrafter3.png"},
...
minetest.register_craft( {
	output = "pipeworks:autocrafter3",
	recipe = {
		{ "pipeworks:autocrafter2", "pipeworks:autocrafter2", "pipeworks:autocrafter2" },
		{ "pipeworks:autocrafter2", "packed_things:packed_gold_8x", "pipeworks:autocrafter2" },
		{ "pipeworks:autocrafter2", "pipeworks:autocrafter2", "pipeworks:autocrafter2" }
	},
})
