...
register_powerbank({ -- Powerbank Mk4
	mark = 4,
	max_charge = 120000000000,
	charge_step = 1200000000,
	charging_slots = 0,
	craft_base = "powerbanks:powerbank_mk3",
	craft_crystal = "space_travel:solar_mese_block"
})
