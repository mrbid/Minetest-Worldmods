...
-- caverealms
mymillwork.register("caverealms:glow_emerald",
...
mymillwork.register("caverealms:glow_obsidian",
    ...
    {cracky=3, light_source=7, level=2}
)

mymillwork.register("caverealms:glow_obsidian_2",
    "caverealms_glow_obsidian2",
    "Glowing Obsidian 2",
    "caverealms_glow_obsidian2.png",
    {cracky=3, light_source=9, hot=1, level=2}
)

mymillwork.register("caverealms:glow_obsidian_brick",
    "caverealms_glow_obsidian_brick",
    "Glowing Obsidian Brick 2",
    "caverealms_glow_obsidian_brick.png",
    {cracky=3, light_source=7, level=2}
)

mymillwork.register("caverealms:glow_obsidian_brick_2",
