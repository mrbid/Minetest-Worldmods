...
minetest.register_node("pipeworks:autocrafter1", {
	description = S("Gold Autocrafter"),
	drawtype = "normal",
	tiles = {"pipeworks_autocrafter1.png"},
...
minetest.register_craft( {
	output = "pipeworks:autocrafter1",
	recipe = {
		{ "default:goldblock", "default:mese", "default:goldblock" },
		{ "pipeworks:autocrafter", "default:diamondblock", "pipeworks:autocrafter" },
		{ "default:goldblock", "default:mese", "default:goldblock" }
	},
})
