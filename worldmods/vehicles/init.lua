...
local function missile_on_step_auxiliary(self, obj, pos)
	...
	if objs then
		...
		-- tnt.boom(self.object:getpos(), {damage_radius=5,radius=0,ignore_protection=false})
		self.object:remove()
	end
end
...
minetest.register_entity("vehicles:bullet", {
	...
	on_activate = function(self)
		...
		minetest.sound_play("shot",
			{pos = pos, gain = 0.4, max_hear_distance = 32, loop = false})
	end,
	on_step = function(self, obj, pos)
		minetest.after(10, function()
			self.object:remove()
...
minetest.register_entity("vehicles:tank", {
	...
	on_rightclick = function(self, clicker)
		...
		elseif not self.driver then
			vehicles.object_attach(self, clicker, {x=0, y=18, z=-3}, true, {x=0, y=6, z=-2})
		end
	end,
...
minetest.register_entity("vehicles:turret", {
	...
	on_rightclick = function(self, clicker)
		if self.driver and clicker == self.driver then
			vehicles.object_detach(self, clicker, {x=1, y=0, z=1})
		elseif not self.driver then
			vehicles.object_attach(self, clicker, {x=0, y=2, z=-4}, true, {x=0, y=2, z=4})
		end
	end,
	on_punch = vehicles.on_punch,
	on_step = function(self, dtime)
...
minetest.register_entity("vehicles:tractor", {
	...
	on_rightclick = function(self, clicker)
		if self.driver and clicker == self.driver then
			vehicles.object_detach(self, clicker, {x=1, y=0, z=1})
		elseif not self.driver then
			vehicles.object_attach(self, clicker, {x=0, y=11.5, z=-10}, true, {x=0, y=2, z=-5})
		end
	end,
	on_punch = vehicles.on_punch,
	on_step = function(self, dtime)
...
minetest.register_entity("vehicles:geep", {
	...
	on_rightclick = function(self, clicker)
		...
		elseif self.driver and clicker ~= self.driver and not self.rider then
			clicker:set_attach(self.object, "", {x=0, y=2.5, z=-5}, {x=0, y=0, z=0}, {x=0, y=0, z=-2})
			self.rider = true
		elseif self.driver and clicker ~=self.driver and self.rider then
			clicker:set_detach()
			self.rider = false
		elseif not self.driver then
			vehicles.object_attach(self, clicker, {x=-2, y=8, z=-1}, true, {x=0, y=2, z=4})
...
minetest.register_entity("vehicles:ambulance", {
	...
	on_rightclick = function(self, clicker)
		if self.driver and clicker == self.driver then
			vehicles.object_detach(self, clicker, {x=1, y=0, z=1})
		elseif self.driver and clicker ~= self.driver and not self.rider then
			clicker:set_attach(self.object, "", {x=0, y=2.5, z=4}, {x=0, y=0, z=0}, {x=0, y=7, z=10})
			self.rider = true
			clicker:set_hp(20)
		elseif self.driver and clicker ~= self.driver and self.rider then
			clicker:set_detach()
...
minetest.register_entity("vehicles:ute2", {
	...
	on_rightclick = function(self, clicker)
		if self.driver and clicker == self.driver then
			vehicles.object_detach(self, clicker, {x=1, y=0, z=1})
		elseif self.driver and clicker ~= self.driver and not self.rider then
			clicker:set_attach(self.object, "", {x=0, y=2.5, z=-5}, {x=0, y=0, z=0})
			self.rider = true
		elseif self.driver and clicker ~=self.driver and self.rider then
			clicker:set_detach()
			self.rider = false
...
minetest.register_entity("vehicles:apache", {
	...
	on_rightclick = function(self, clicker)
		if self.driver and clicker == self.driver then
			vehicles.object_detach(self, clicker, {x=1, y=0, z=1})
		elseif not self.driver then
			vehicles.object_attach(self, clicker, {x=0, y=17.5, z=17}, true, {x=0, y=10, z=14})
		end
	end,
	on_punch = vehicles.on_punch,
	on_step = function(self, dtime)
...
minetest.register_entity("vehicles:plane", {
	...
	on_rightclick = function(self, clicker)
		if self.driver and clicker == self.driver then
			vehicles.object_detach(self, clicker, {x=1, y=0, z=1})
		elseif not self.driver then
			vehicles.object_attach(self, clicker, {x=0, y=12, z=-2.5}, true, {x=0, y=9, z=0})
		end
	end,
	on_punch = vehicles.on_punch,
	on_step = function(self, dtime)
...
minetest.register_tool("vehicles:wings", {
	...
	on_use = function(item, placer, pointed_thing)
		...
		if wings_ready then
			...
			local entity = obj:get_luaentity()
			placer:set_attach(entity.object, "", {x=0,y=3.7,z=0}, {x=0,y=-3,z=0})
